...
import "./hhrilqm27fbjs70g.js";
import "./fl41y0is7h6g0gxe.js";
import "./cxz91putlw7pmfk2.js";
const he = s => o.createElement("svg", {
        width: 24,
        height: 24,
        viewBox: "0 0 24 24",
        fill: "none",
...
function fe({
    ...
    const t = E(),
        i = F(w.hasSeenAdvancedVoiceNuxFullPage),
        c = z(),
        r = c ? .isPlus() ? ? !1,
        g = c ? .isEnterprisey() ? ? !1,
        v = !r && !g,
        u = "https://help.openai.com/en/articles/8400625-voice-mode-faq#h_c5d6fe534b",
        [d, h] = o.useState(!1),
        [x, y] = o.useState(!1),
        [C, N] = o.useState(!1),
        [m, b] = o.useState(!0);
    ...
    const j = () => {
            N(!0), k.voiceAdvancedDisclosureAccepted.click(), h(!0), setTimeout(async () => {
                b(!1)
            }, se)
        },
        f = () => {
    ...
    return e.jsxs(e.Fragment, {
        children: [e.jsx(B, {
            ...
            type: "success",
            size: "fullscreen",
            className: `bg-white transition-opacity duration-300 dark:bg-gray-800 ${x&&!C?"opacity-100":"opacity-0"}`,
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsx("h1", {
                    className: "mb-9 text-2xl font-semibold text-token-text-primary",
                    children: v ? t.formatMessage({
                        id: "XV3+9K",
                    ...
                    children: A.map((l, P) => e.jsx("div", {
                        children: l
                    }, P))
                }), e.jsxs("p", {
                    className: "mb-9 text-sm text-token-text-primary",
                    children: [t.formatMessage({
                        id: "vtcf3s",
                    ...
                    className: "rounded-full bg-token-text-primary px-20 py-3 font-semibold",
                    onClick: j,
                    children: e.jsx(T, {
                        id: "ppi93b",
...
function pe() {
    const s = F(w.hasSeenAdvancedVoiceNuxFullPage);
    return !s.isLoading && s.eligible
}

function ge() {
    const s = ie() ? w.hasSeenAdvancedVoiceWebNuxTooltip : w.hasSeenAdvancedVoiceRealWebNuxTooltip,
        a = F(s);
    return {
        shouldShowTooltipNux: !a.isLoading && a.eligible,
        tooltipAnnouncement: a,
        announcementKey: s
    }
}
...
function Pe({
    ...
    const t = de(),
        ...
        g = r.formatMessage({
            id: "HDu59A",
            defaultMessage: "Start voice mode"
        }),
        [v, u] = o.useState(!1),
        d = pe(),
        {
            shouldShowTooltipNux: h,
            tooltipAnnouncement: x,
            announcementKey: y
        } = ge(),
        [C, N] = o.useState(!1),
        m = c ? ? s,
        b = me(n => n.isVoiceModeActive),
        {
            startVoiceMode: j
        } = ue(),
        {
            prospectiveModelId: f
        } = te(s),
        {
            setValue: p
        } = le(H.VoiceName),
        {
            getUpsellLabelType: V
        } = oe(),
        S = V() === "all";
    o.useEffect(() => {
        d || u(!1)
    }, [d]), o.useEffect(() => {
        const n = sessionStorage.getItem("selectedVoiceName"),
            A = async l => {
                try {
                    sessionStorage.removeItem("selectedVoiceName"), await j({
                        voice: l,
                        conversation_id: void 0,
                        eventSource: "login_page",
                        voice_mode: "advanced",
                        clientThreadId: G(),
                        gizmo_id: Q.getGizmoId(Y(m)),
                        requested_default_model: f ? ? void 0
                    })
                } catch (P) {
                    X.addError(`Failed to start voice mode after voice picker: ${P}`)
                }
            };
        n && !i && (p(n), A(n))
    }, [m, i, p, j, f]);
    const M = o.useCallback(async () => {
        if (L.logEventWithStatsig(O.composerSpeechButtonClicked, "composer_speech_button_clicked"), i) return k.voiceSelectionShown.click(i ? {
            isUnauthenticated: !0,
            eventSource: "composerSpeechButton"
        } : {}), N(!0);
        if (h && x.markAsViewed(), d) {
            k.voiceAdvancedDisclosureShown.success(), u(!0);
            return
        }
        t.setState(n => {
            n.isVoiceModeActive = !0
        })
    }, [i, h, d, x, t]);
    return e.jsx(e.Fragment, {
        children: v ? e.jsx(fe, {
            ...
            children: e.jsxs("button", {
                ...
                "aria-label": g,
                disabled: b,
                className: W(ce, S ? "min-w-8 p-2" : a ? "w-7" : "w-9", a && "!h-7"),
                style: {
                ...
                children: [e.jsx("div", {
                    ...
                    className: "whitespace-nowrap pl-1 pr-1 text-[13px] font-semibold [display:--force-hide-label]",
                    children: r.formatMessage(Ce.voiceLabel)
                })]
            })
        })
    })
...
function ve({
    ...
    return a ? e.jsx(ne, {
        ...
        title: c.formatMessage({
            id: "DQ6CAP",
            defaultMessage: "Try advanced voice mode"
        }),
        contentAlign: "center",
        ...
        label: c.formatMessage({
            id: "i4P/ix",
            defaultMessage: "Use voice mode"
        }),
        side: "top",
        onOpenChange: r => {
            r && (L.logEvent(O.composerSpeechButtonHovered), k.composerSpeechButton.hover())
        },
        children: s
    })
}
const Ce = K({
    voiceLabel: {
        id: "composerSpeechUpsell.voiceLabel",
        defaultMessage: "Voice"
    }
});
export {
    Pe as ComposerSpeechButton
};
//# sourceMappingURL=mzotw30gexbxhfpo.js.map